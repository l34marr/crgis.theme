...
#
#  $ bin/test -s crgis.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src crgis.theme.testing.CRGIS_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/crgis/theme/tests/robot/test_example.robot
#
